...
Game.grade5NumberSense.prototype={
	...
	create:function(game){
		...
		_this.spatialRelationshipGroup2.y = 900;
		...
		_this.mc = new Hammer(_this.page);
           ...
           _this.mc.on("swiperight", function () { 
			...
			//	{
					...
					//	swipeDownFlag = true;
						_this.tween = null;
						if(_this.graphicsBg.y<=-632)
						{
							//swipeUpFlag = false;
							_this.graphicsBg.y = -632;
						}
			...
			_this.input.onDown.add(function(){
				...
				_this.graphicsBg.events.onDragUpdate.add(function(){
					...
					else if(_this.graphicsBg.y<=-632)
						{
							//swipeUpFlag = false;
							_this.graphicsBg.y = -632;
							//tween.stop();
	...
	playDemoVideos:function(target){
        ...
        switch(target)
        {
            case 'nsf1_5':  if(window.languageSelected =="English")
                    ...
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsf1.5/Marathi/nsf1.5.mp3");
                    }
					else if(window.languageSelected =="Telugu")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsf1.5/Telugu/nsf1.5.mp3");
                    }
					else if(window.languageSelected =="Tamil")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsf1.5/Tamil/nsf1.5.mp3");
                    }
					else if(window.languageSelected =="Urdu")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsf1.5/Urdu/nsf1.5.mp3");
                    }
                  else
                    {
            ...
            case 'nsd2_5':  if(window.languageSelected =="English")
                    ...
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd2.5/Marathi/nsd2.5a.mp3");
                    }
					else if(window.languageSelected =="Telugu")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd2.5/Telugu/nsd2.5a.mp3");
                    }
					else if(window.languageSelected =="Tamil")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd2.5/Tamil/nsd2.5a.mp3");
                    }
					else if(window.languageSelected =="Urdu")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd2.5/Urdu/nsd2.5a.mp3");
                    }
                  else
                    {
            ...
            case 'nsd6_5a':  if(window.languageSelected =="English")
                    ...
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd6.5/Marathi/nsd6.5a.mp3");
                    }
					else if(window.languageSelected =="Telugu")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd6.5/Telugu/nsd6.5a.mp3");
                    }
					else if(window.languageSelected =="Tamil")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd6.5/Tamil/nsd6.5a.mp3");
                    }
					else if(window.languageSelected =="Urdu")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd6.5/Urdu/nsd6.5a.mp3");
                    }
                  else
                    {
             ...
             case 'nsd6_5b':  if(window.languageSelected =="English")
                    ...
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd6.5/Marathi/nsd6.5b.mp3");
                    }
					else if(window.languageSelected =="Telugu")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd6.5/Telugu/nsd6.5b.mp3");
                    }
					else if(window.languageSelected =="Tamil")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd6.5/Tamil/nsd6.5b.mp3");
                    }
					else if(window.languageSelected =="Urdu")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd6.5/Urdu/nsd6.5b.mp3");
                    }
                    else if(window.languageSelected =="Gujarati")
                    {
	...
	firstVoice2:function(target){
        ...
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/English/Fill_the_boxes.mp3");
        }
        else if(window.languageSelected=="Hindi")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Hindi/Fill_the_boxes.mp3");
        }
        else if(window.languageSelected=="Kannada")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Kannada/Fill_the_boxes.mp3");
        }
        else if(window.languageSelected=="Gujarati")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Gujarati/Fill_the_boxes.mp3");
        }
        else if(window.languageSelected=="Marathi")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Marathi/Fill_the_boxes.mp3");
        }
        else if(window.languageSelected=="Odiya")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Odiya/Fill_the_boxes.mp3");
        }
        else if(window.languageSelected=="Tamil")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Tamil/Fill_the_boxes.mp3");
        }
        else if(window.languageSelected=="Telugu")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Telugu/Fill_the_boxes.mp3");
        }
        else if(window.languageSelected=="Urdu")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Urdu/Fill_the_boxes.mp3");
        }
    ...
    secondVoice2:function(target){
        ...
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/English/Drag_the_pictures.mp3");
        }
        else if(window.languageSelected=="Hindi")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Hindi/Drag_the_pictures.mp3");
        }
        else if(window.languageSelected=="Kannada")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Kannada/Drag_the_pictures.mp3");
        }
        else if(window.languageSelected=="Gujarati")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Gujarati/Drag_the_pictures.mp3");
        }
        else if(window.languageSelected=="Marathi")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Marathi/Drag_the_pictures.mp3");
        }
        else if(window.languageSelected=="Odiya")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Odiya/Drag_the_pictures.mp3");
        }
        else if(window.languageSelected=="Tamil")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Tamil/Drag_the_pictures.mp3");
        }
        else if(window.languageSelected=="Telugu")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Telugu/Drag_the_pictures.mp3");
        }
        else if(window.languageSelected=="Urdu")
        {
            this.src = document.createElement('source');
            this.src.setAttribute("src","./questionSounds/NSN1/Urdu/Drag_the_pictures.mp3");
        }
