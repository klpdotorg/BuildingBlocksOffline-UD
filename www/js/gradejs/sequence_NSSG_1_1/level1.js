	...
	create:function(game){
       ...
       _this.generateStarsForTheScene(game,9);
        ...
        if(window.languageSelected=="English")
                    ...
                    {
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/2.1.1/Marathi/question2.1.mp3");
                    }
					else if(window.languageSelected=="Telugu")
                    {
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/2.1.1/Telugu/question2.1.mp3");
                    }
					else if(window.languageSelected=="Tamil")
                    {
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/2.1.1/Tamil/question2.1.mp3");
                    }
					else if(window.languageSelected=="Urdu")
                    {
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/2.1.1/Urdu/question2.1.mp3");
                    }
                    else
