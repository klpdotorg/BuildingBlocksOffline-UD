...
Game.unity12_3_1level1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.timebg = _this.add.sprite(305,6,'Unity12_3_1timebg');
        ...
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/12.3.1/Marathi/12.3.1.mp3");
        }
		else if(window.languageSelected=="Tamil")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/12.3.1/Tamil/12.3.1.mp3");
        }
		else if(window.languageSelected=="Telugu")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/12.3.1/Telugu/12.3.1.mp3");
        }
		else if(window.languageSelected=="Urdu")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/12.3.1/Urdu/12.3.1.mp3");
        }
        else
        {
...
//                     }
    ...
    {  
       ...
       // _this.framesChange1 = [1,2,3,4,5,7,8,9];
        ...
        _this.SecondNumbers4 = this.add.sprite(_this.world.centerX-370,_this.world.centerY-60,'Unity12_3_1greenNumbers');
...
//        }
        ...
        //_this.DragEggGrp.add(_this.NumberGrp);
...
//                _this.addNumberPadGrp.pivot.setTo(_this.world.centerX,_this.world.centerY);
//                _this.addNumberPadGrp.x = 480;
//                
//                _this.addNumberPadGrp.pivot.setTo(_this.world.centerX,_this.world.centerY);
//                _this.addNumberPadGrp.y = 270;
//                _this.addNumberPadGrp.angle = -2;
//                
//                var tween = _this.add.tween(_this.addNumberPadGrp);
//                tween.to({ angle: -1 }, 100, 'Linear', true, 0);
//                
//                tween.onComplete.add(function(){
//                    var tween1 = _this.add.tween(_this.addNumberPadGrp);
//                    tween1.to({ angle: 2}, 100, 'Linear', true, 0);
//                    
//                    tween1.onComplete.add(function(){
//                        var tween2 = _this.add.tween(_this.addNumberPadGrp);
//                        tween2.to({ angle: -1 }, 100, 'Linear', true, 0);
//                        
//                        tween2.onComplete.add(function(){
//                            var tween3 = _this.add.tween(_this.addNumberPadGrp);
//                            tween3.to({ angle: 2 }, 100, 'Linear', true, 0);
//                            
