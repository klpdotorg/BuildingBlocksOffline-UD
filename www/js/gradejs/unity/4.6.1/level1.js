        ...
        /*var allClear = true; 
         for(var j=0;j<_this.SquareGrp.length;j++)
         {
            for(var k=0;k<_this.numGrp.length;k++)
            {
                ...
                {
                    console.log("here1 "+j);
                    console.log("fffffffffffffff "+_this.SquareGrp.getChildAt(j).x);
                    console.log("fffffffffffffff "+_this.numGrp.getChildAt(k).x);
                    console.log("fffffffffffffff "+_this.SquareGrp.getChildAt(j).y);
                    console.log("fffffffffffffff "+_this.numGrp.getChildAt(k).y);
            ...
            if(_this.checkOverlap(target,_this.SquareGrp.getChildAt(i)) && _this.SquareGrp.getChildAt(i).canAdd)
                {
                   ...
                   //_this.SquareGrp.getChildAt(i).canAdd = false;
                    //target.value = 0;
