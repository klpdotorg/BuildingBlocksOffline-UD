		  ...
		  _this.src = document.createElement('source');
            switch( _this.qArrays[ _this.no1])
            {
                ...
                case 15:if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/3.2.1/English/Game 7.1.2.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/3.2.1/Hindi/Game 7.1.2.mp3");
                        }
                        else if(window.languageSelected == "Kannada")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/3.2.1/Kannada/Game 7.1.2.mp3");
                        }
			...
			else if(window.languageSelected=="Urdu")
            {
                _this.src.setAttribute("src", window.baseUrl+"questionSounds/3.2.1/Urdu/7.1.2.mp3");
                        ...
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/3.2.1/Odiya/7.1.2.mp3");
