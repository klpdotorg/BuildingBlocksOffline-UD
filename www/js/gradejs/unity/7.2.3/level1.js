...
Game.unity7_2_3level1.prototype={
	...
	create:function(game){
		...
		_this.physics.setBoundsToWorld();
           ...
           _this.bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level723_bg1');
            _this.navBar = _this.add.sprite(0,0,'Level723_navBar');
             ...
             _this.timebg = _this.add.sprite(305,6,'Level723_timebg');
       ...
       _this.speakerbtn = _this.add.sprite(600,6,'Level723_CommonSpeakerBtn');
  ...
  return array;
    ...
    getVoice:function(){
		...
		{
			_this.src.setAttribute("src", window.baseUrl+"questionSounds/Gujarati/3.2.1/Game7.2.1.mp3");
		}
		else
        {
