     ...
     init:function(param,score,timerStopVar)
    {
       ...
       if(window.languageSelected == "English")
                        ...
                        else if(window.languageSelected == "Gujarati")
                        {
                            ...
                            {
                                _this.qsoundurl= window.baseUrl+"questionSounds/3.2.1/Marathi/17.3.mp3";
                            }
							else if(window.languageSelected=="Telugu")
                            {
                               _this.qsoundurl= window.baseUrl+"questionSounds/3.2.1/Telugu/17.3.mp3";
                            }
							else if(window.languageSelected=="Tamil")
                            {
                                _this.qsoundurl= window.baseUrl+"questionSounds/3.2.1/Tamil/17.3.mp3";
                            }
							else if(window.languageSelected=="Urdu")
                            {
                                _this.qsoundurl= window.baseUrl+"questionSounds/3.2.1/Urdu/17.3.mp3";
                            }
                       else
                      {
