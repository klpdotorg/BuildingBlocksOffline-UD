...
Game.unity4_1_1Newlevel1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.backbtn = _this.add.button(5,5,'grade11_backbtn',function(){ 
        ...
        _this.timebg = _this.add.sprite(300,7,'Level42C_timer');

        _this.timeDisplay = _this.add.text(325,23,_this.minutes + ' : '+ _this.seconds);
...
//        {
//            _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.1.1/English/4.2.mp3");
//        }
//        else if(window.languageSelected=="Hindi")
//        {
//            _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.1.1/Hindi/4.2.mp3");
//        }
//        else if(window.languageSelected=="Kannada")
//        {
//            _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.1.1/Kannada/4.2.mp3");
//        }
//        else
//        {
//            _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.1.1/Odiya/4.2.mp3");
//        }
//        
...
//        {
//            //tweeing up
//            _this.tween1 = _this.add.tween(_this.lock1);
//            _this.tween1.to({ y: 100 }, 0, 'Linear', true,0);
//           // _this.tween.to({ angle: -10 }, 0, 'Linear', true, 0);
//            _this.tween1.repeat(1, 100);
//             
//            _this.tween1.onComplete.add(function()
//            {
//                //tweeing down
//                _this.tween2 = _this.add.tween(_this.lock1);
//                _this.tween2.to({ y:-100 }, 0, 'Linear', true, 0);
//               // _this.tween.to({ angle: -10 }, 0, 'Linear', true, 0);
//                //_this.tween1.repeat(0, 1000);
//            },this);  
//   
//        },this);           
    },
...
//        {
//            //tweeing up
//            _this.tween = _this.add.tween(_this.lock1);
//            _this.tween.to({ y: 100 }, 0, 'Linear', true, 0);
//           // _this.tween.to({ angle: -10 }, 0, 'Linear', true, 0);
//            _this.tween.repeat(1, 1000);
//            
//        },this);
    },
