        ...
        this.addNumberPad();*/
		 ...
		 if(qArrays[no1] ==5 || qArrays[no1] == 6 ||qArrays[no1]==7 || qArrays[no1]==8 || qArrays[no1]==9){
			...
			kgTxt1.fontSize = 45;
			  ...
			  kgTxt0 = this.add.text(565,300, _this.firstValue+"  "+"       x "+_this.secondValue+" = ");
				kgTxt = this.add.text(545,305, "मिलीलिटर");
				kgTxt1 = this.add.text(814,305, "मिलीलिटर");
				kgTxt0.font = 'myfont';
				kgTxt.font = 'Comic Sans MS';
				kgTxt1.font = 'Comic Sans MS';
				kgTxt0.fontSize = 38;
			  ...
			  kgTxt0 = this.add.text(565,300, _this.firstValue+"  "+"       x "+_this.secondValue+" = ");
				...
				kgTxt1 = this.add.text(814,305, "ملی لیٹر");
				kgTxt0.font = 'myfont';
				kgTxt.font = 'Comic Sans MS';
				kgTxt1.font = 'Comic Sans MS';
				kgTxt0.fontSize = 38;
		 ...
		 if(window.languageSelected=="English"){
			...
			kgTxt1.fontSize = 40;
			  ...
			  kgTxt0 = this.add.text(565,300, _this.firstValue+"  "+"        x "+_this.secondValue+" = ");
				kgTxt = this.add.text(535,305, "मिलीलिटर");
				kgTxt1 = this.add.text(814,305, "मिलीलिटर");
				kgTxt0.font = 'myfont';
				kgTxt.font = 'Comic Sans MS';
				kgTxt1.font = 'Comic Sans MS';
...
//            starsGroup1.visible=false;
    ...
    {   
       ...
       if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.3A/Marathi/4.3A1.mp3");
                    }
					else if(window.languageSelected == "Telugu")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.3A/telugu/4.3A1.mp3");
                    }
					else if(window.languageSelected == "Tamil")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.3A/Tamil/4.3A1.mp3");
                    }
					else if(window.languageSelected == "Urdu")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.3A/Urdu/4.3A1.mp3");
                    }
					else
                    {
