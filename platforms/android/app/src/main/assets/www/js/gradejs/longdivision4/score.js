Game.longdivision4Score=function(game){

};
var background4;
var replay;

Game.longdivision4Score.prototype={
	create:function(game){
		...
		//{
			...
			_this.nextBtn.events.onInputDown.add(function()
			{
	            ...
	            _this.clickSound.play();
				//_this.cache.destroy();
				_this.state.start('longdivision6',true,false); 
			},_this);
		//}
       ...
       // _this.nextBtn.visible = false;
                ...
                _this.replay.events.onInputDown.add(function(){ 
					...
					_this.clickSound = _this.add.audio('ClickSound');
					_this.clickSound.play();
                    _this.state.start('longdivision4',true,false);
                 },_this);
